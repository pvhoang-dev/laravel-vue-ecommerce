<x-app-layout>
    <form action="" method="post" class="w-[400px] mx-auto p-6 my-16" x-data="signupForm" @submit.prevent="submit">
        ...
        <div class="mb-4">
            <input placeholder="Your name" type="text" name="name" x-model="form.name" @input="validateName()"
        ...
        <div class="mb-4">
            <input placeholder="Repeat Password" type="password" name="password" x-model="form.password_repeat"
                @input="validatePasswordRepeat()" class="border-gray-300 focus:outline-none  rounded-md w-full"
